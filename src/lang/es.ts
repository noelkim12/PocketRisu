...
export const languageSpanish = {
    ...
    "ebookReader": "Lector de ebooks",
    "enableEbookReader": "Activar lector de ebooks",
    "ebookReaderUpdated": "Lector de ebooks actualizado",
    "ebookReaderCaptureFailed": "Algunos mensajes aún no se pudieron capturar. Intenta cambiar de página o actualizar el lector.",
    "ebookReaderPaginationFailed": "El lector de ebooks no pudo paginar este bloque.",
    "ebookReaderJumpToOriginal": "Ir al chat original",
    "ebookReaderEditInOriginal": "Editar en el chat original",
    "ebookReaderEditJumpNotice": "Se abrió el chat original para que puedas editar el mensaje.",
    "ebookReaderPreviousPage": "Página anterior",
    "ebookReaderNextPage": "Página siguiente",
    "ebookReaderClose": "Cerrar lector de ebooks",
    "ebookReaderCustomization": "Personalización del lector de ebooks",
    "ebookReaderAppearance": "Apariencia",
    "ebookReaderAppearanceSystem": "Sistema",
    "ebookReaderAppearanceLight": "Claro",
    "ebookReaderAppearanceDark": "Oscuro",
    "ebookReaderAppearanceSepia": "Sepia",
    "ebookReaderFontSize": "Tamaño de fuente",
    "ebookReaderLineHeight": "Altura de línea",
    "ebookReaderFontFamily": "Familia de fuente",
    "ebookReaderFontFamilyInherit": "Usar fuente de la app",
