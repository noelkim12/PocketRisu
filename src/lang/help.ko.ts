...
export const helpKo = {
        ...
        "enableEbookReader": "전자책 스타일 리더 오버레이와 채팅 메뉴 바로가기를 활성화합니다.",
        ...
        "chatRenderSwapDelayMs": "채팅 메시지가 다시 렌더링될 때, PocketRisu는 새 HTML을 숨겨진 스테이징 레이어에서 준비하는 동안 현재 보이는 HTML을 유지할 수 있습니다. 이 값은 스테이징 렌더가 준비된 뒤 화면에 교체하기 전까지 기다릴 시간을 제어합니다. 0이면 즉시 교체하고, 무거운 디스플레이 수정 스크립트나 인레이 렌더링의 깜빡임을 줄이려면 100~200ms 정도를 사용하세요.",
