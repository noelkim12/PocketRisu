...
export const languageVietnamese = {
    ...
    "ebookReader": "Trình đọc ebook",
    "enableEbookReader": "Bật trình đọc ebook",
    "ebookReaderUpdated": "Trình đọc ebook đã cập nhật",
    "ebookReaderCaptureFailed": "Một số tin nhắn chưa thể được ghi lại. Hãy thử chuyển trang hoặc làm mới trình đọc.",
    "ebookReaderPaginationFailed": "Trình đọc ebook không thể phân trang đoạn này.",
    "ebookReaderJumpToOriginal": "Chuyển đến trò chuyện gốc",
    "ebookReaderEditInOriginal": "Sửa trong trò chuyện gốc",
    "ebookReaderEditJumpNotice": "Đã chuyển đến trò chuyện gốc để bạn có thể sửa tin nhắn.",
    "ebookReaderPreviousPage": "Trang trước",
    "ebookReaderNextPage": "Trang tiếp theo",
    "ebookReaderClose": "Đóng trình đọc ebook",
    "ebookReaderCustomization": "Tùy chỉnh trình đọc ebook",
    "ebookReaderAppearance": "Giao diện",
    "ebookReaderAppearanceSystem": "Hệ thống",
    "ebookReaderAppearanceLight": "Sáng",
    "ebookReaderAppearanceDark": "Tối",
    "ebookReaderAppearanceSepia": "Nâu đỏ",
    "ebookReaderFontSize": "Cỡ chữ",
    "ebookReaderLineHeight": "Chiều cao dòng",
    "ebookReaderFontFamily": "Kiểu chữ",
    "ebookReaderFontFamilyInherit": "Dùng phông chữ ứng dụng",
