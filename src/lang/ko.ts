...
export const languageKorean = {
    ...
    "ebookReader": "E-Book 리더",
    "enableEbookReader": "E-Book 리더 활성화",
    "ebookReaderUpdated": "E-Book 리더가 업데이트되었습니다",
    "ebookReaderCaptureFailed": "일부 메시지를 아직 캡처할 수 없습니다. 페이지를 이동하거나 리더를 새로고침해 보세요.",
    "ebookReaderPaginationFailed": "E-Book 리더가 이 묶음을 페이지로 나눌 수 없습니다.",
    "ebookReaderJumpToOriginal": "원본 채팅으로 이동",
    "ebookReaderEditInOriginal": "원본 채팅에서 편집",
    "ebookReaderEditJumpNotice": "메시지를 편집할 수 있도록 원본 채팅으로 이동했습니다.",
    "ebookReaderPreviousPage": "이전 페이지",
    "ebookReaderNextPage": "다음 페이지",
    "ebookReaderClose": "E-Book 리더 닫기",
    "ebookReaderCustomization": "E-Book 리더 커스터마이징",
    "ebookReaderAppearance": "외형",
    "ebookReaderAppearanceSystem": "시스템",
    "ebookReaderAppearanceLight": "라이트",
    "ebookReaderAppearanceDark": "다크",
    "ebookReaderAppearanceSepia": "세피아",
    "ebookReaderFontSize": "글자 크기",
    "ebookReaderLineHeight": "줄 간격",
    "ebookReaderParagraphSpacing": "문단 간격",
    "ebookReaderDisplayOptions": "리더 표시 옵션",
    "ebookReaderResetDisplayOptions": "표시 옵션 초기화",
    "ebookReaderFontFamily": "글꼴",
    "ebookReaderFontFamilyInherit": "앱 글꼴 사용",
    "ebookReaderFontFamilySerif": "세리프",
