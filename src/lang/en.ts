...
export const languageEnglish = {
    ...
    enableEbookReader: "Enable Ebook Reader",
    ebookReaderUpdated: "Ebook reader updated",
    ebookReaderCaptureFailed: "Some messages could not be captured yet. Try moving pages or refreshing the reader.",
    ebookReaderPaginationFailed: "Ebook reader could not paginate this chunk.",
    ebookReaderJumpToOriginal: "Jump to original chat",
    ebookReaderEditInOriginal: "Edit in original chat",
    ebookReaderEditJumpNotice: "Jumped to the original chat so you can edit the message.",
    ebookReaderPreviousPage: "Previous page",
    ebookReaderNextPage: "Next page",
    ebookReaderClose: "Close ebook reader",
    ebookReaderCustomization: "Ebook Reader Customization",
    ebookReaderAppearance: "Appearance",
    ebookReaderAppearanceSystem: "System",
    ebookReaderAppearanceLight: "Light",
    ebookReaderAppearanceDark: "Dark",
    ebookReaderAppearanceSepia: "Sepia",
    ebookReaderFontSize: "Font Size",
    ebookReaderLineHeight: "Line Height",
    ebookReaderParagraphSpacing: "Paragraph Spacing",
    ebookReaderDisplayOptions: "Reader display options",
    ebookReaderResetDisplayOptions: "Reset display options",
    ebookReaderFontFamily: "Font Family",
    ebookReaderFontFamilyInherit: "Use App Font",
