...
export const languageChinese = {
    ...
    "ebookReader": "电子书阅读器",
    "enableEbookReader": "启用电子书阅读器",
    "ebookReaderUpdated": "电子书阅读器已更新",
    "ebookReaderCaptureFailed": "部分消息暂时无法捕获。请尝试翻页或刷新阅读器。",
    "ebookReaderPaginationFailed": "电子书阅读器无法为此片段分页。",
    "ebookReaderJumpToOriginal": "跳转到原始聊天",
    "ebookReaderEditInOriginal": "在原始聊天中编辑",
    "ebookReaderEditJumpNotice": "已跳转到原始聊天，你可以编辑该消息。",
    "ebookReaderPreviousPage": "上一页",
    "ebookReaderNextPage": "下一页",
    "ebookReaderClose": "关闭电子书阅读器",
    "ebookReaderCustomization": "电子书阅读器自定义",
    "ebookReaderAppearance": "外观",
    "ebookReaderAppearanceSystem": "系统",
    "ebookReaderAppearanceLight": "浅色",
    "ebookReaderAppearanceDark": "深色",
    "ebookReaderAppearanceSepia": "棕褐色",
    "ebookReaderFontSize": "字体大小",
    "ebookReaderLineHeight": "行高",
    "ebookReaderFontFamily": "字体系列",
    "ebookReaderFontFamilyInherit": "使用应用字体",
    "ebookReaderFontFamilySerif": "衬线",
